...
const int BUTTON_ARDUINO_PIN[4] = {D22, D24, D26, D28};  // pins of each button connected straight to the Arduino
...
const int POT_ARDUINO_PIN[4] = {A0, A1, A2, A3};  // pins of each pot connected straight to the Arduino
